...
// Using placeholder images since the my folder doesn't exist yet
const profileImg = 'https://via.placeholder.com/100x100?text=Profile';
const bookmarkIcon = 'https://via.placeholder.com/24x24?text=📑';
const editIcon = 'https://via.placeholder.com/24x24?text=✏️';
const charlesImg = 'https://via.placeholder.com/70x70?text=Charles';
const kimiImg = 'https://via.placeholder.com/70x70?text=Kimi';
const postImg1 = 'https://via.placeholder.com/200x300?text=Post+1';
const postImg2 = 'https://via.placeholder.com/200x200?text=Post+2';
const postImg3 = 'https://via.placeholder.com/200x200?text=Post+3';
const postImg4 = 'https://via.placeholder.com/200x300?text=Post+4';
const postImg5 = 'https://via.placeholder.com/200x200?text=Post+5';
const postImg6 = 'https://via.placeholder.com/200x200?text=Post+6';
const shortsImg1 = 'https://via.placeholder.com/150x250?text=Short+1';
const shortsImg2 = 'https://via.placeholder.com/150x250?text=Short+2';
const shortsImg3 = 'https://via.placeholder.com/150x250?text=Short+3';
const shortsImg4 = 'https://via.placeholder.com/150x250?text=Short+4';
const shortsImg5 = 'https://via.placeholder.com/150x250?text=Short+5';
const addDriverImg = 'https://via.placeholder.com/70x70?text=+';
const plusIcon = 'https://via.placeholder.com/24x24?text=+';
const heartIcon = 'https://via.placeholder.com/16x16?text=❤️';
const chatIcon = 'https://via.placeholder.com/16x16?text=💬';
const arrowIcon = 'https://via.placeholder.com/16x16?text=→';
const commentUserImg = 'https://via.placeholder.com/40x40?text=User';
