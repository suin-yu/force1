...
const TeamsPg = () => {
  ...
  const ITEM_HEIGHT = 60; // 아이템 높이

  // 터치/드래그 핸들러 (배너 수동 슬라이드)
  ...
  const handleButtonClick = () => {
    setIsModalOpen(true); // 모달 열기 (기존 기능)
  ...
  const handleComplete = () => {
    if (yearScrollRef.current && teamScrollRef.current) {
      // 1. 연도 계산: (현재 스크롤 위치 / 아이템 높이)
      ...
      // 2. 팀 계산
      const teamIndex = Math.round(teamScrollRef.current.scrollTop / ITEM_HEIGHT);
      const finalTeam = teams[Math.max(0, Math.min(teamIndex, teams.length - 1))];
  ...
  return (
    <div className="teams-page-content">
      ...
      <header className="teams-header">
        <button
          // isShining 상태에 따라 active-glow 클래스 추가
          className={`selector-button ${isShining ? "active-glow" : ""}`}
          onClick={handleButtonClick}
          onAnimationEnd={() => setIsShining(false)}
        >
          {/* 내부 콘텐츠를 보호하기 위한 wrap */}
      ...
      <div className="team-intro-section">
        ...
        <div className="team-slogan">
          <img
            src="/src/assets/img/teams/ferrari.png"
            alt="Ferrari"
        ...
        <div className="drivers-grid">
          <div className="driver-card">
            <img
              src="/src/assets/img/teams/leclerc.png"
              alt="Leclerc"
          ...
          <div className="driver-card">
            <img
              src="/src/assets/img/teams/hamilton.png"
              alt="Hamilton"
              className="driver-img"
            />
        ...
        <div className="performance-car-container">
          ...
          <div className="car-bg-wrapper">
            <img
              src="/src/assets/img/teams/car_bg.png"
              alt="Ferrari Car"
          ...
          <div className="meet-the-team-wrapper">
            ...
            <div className="staff-group frederic-set">
              ...
              <div className="main-staff">
                <div className="staff-circle">
                  <img
                    src="/src/assets/img/teams/meet_1.png"
            ...
            <div className="staff-group enrico-set">
              ...
              <div className="main-staff">
                <div className="staff-circle">
                  <img
                    src="/src/assets/img/teams/meet_2.png"
            ...
            <div className="staff-group loic-set">
              ...
              <div className="main-staff">
                <div className="staff-circle">
                  <img
                    src="/src/assets/img/teams/meet_3.png"
                    alt="Loic Serra"
                  />
                </div>
                <div className="staff-label right">
              ...
              {[
                {
                  ...
                  kr: "루이지 첸터나리",
                  img: "/src/assets/img/teams/meet_4.png",
                },
                {
                  role: "Deputy Team Principal",
                  name: "Jerome d’ambrosio",
                  kr: "제롬 담브로지오",
                  img: "/src/assets/img/teams/meet_5.png",
                },
                {
                  role: "Head Of Track Engineering",
                  name: "Matteo togninalli",
                  kr: "마테오 토닌날리",
                  img: "/src/assets/img/teams/meet_6.png",
                },
                {
                  role: "Sporting Director",
                  name: "Diego Ioverno",
                  kr: "디에고 이오베르노",
                  img: "/src/assets/img/teams/meet_7.png",
                },
                {
                  role: "Reserve Driver",
                  name: "Antonio Giovinazzi",
                  kr: "안토니오 지오비나치",
                  img: "/src/assets/img/teams/meet_8.png",
                },
              ].map((staff, idx) => (
                ...
                {[
                  {
                    id: 1,
                    title: "마지막 코너, 승부의 순간",
                    img: "/src/assets/img/teams/teams_high1.png",
                  },
                  {
                    id: 2,
                    title: "은빛 화살에서 붉은 열정으로",
                    img: "/src/assets/img/teams/teams_high2.png",
                  },
                ].map((item) => (
              ...
              {[
                {
                  ...
                  date: "2025.12.10",
                  img: "/src/assets/img/teams/teams_news1.png",
                },
                {
                  id: 2,
                  ...
                  date: "2025.12.07",
                  img: "/src/assets/img/teams/teams_news2.png",
                },
              ].map((news) => (
              ...
              <div className="picker-column" ref={teamScrollRef}>
                <div className="picker-scroll">
                  ...
                  {teams.map((team) => (
                    <div
                      key={team}
                      className={`picker-item ${selectedTeam === team ? "active" : ""
                        }`}
                      onClick={() => {
                        const idx = teams.indexOf(team);
                        teamScrollRef.current.scrollTo({ top: idx * ITEM_HEIGHT, behavior: 'smooth' });
                      }}
                    >
                      {team}
                    </div>
