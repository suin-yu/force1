...
import charlesImg from '../../assets/img/teams/leclerc.png'; // ✅ Charles Leclerc 이미지 경로
import hamiltonImg from '../../assets/img/teams/hamilton.png'; // ✅ Hamilton 이미지 경로
...
const HomePg = () => {
  ...
  const drivers = [
    ...
    { id: 2, name: 'Lewis Hamilton', img: hamiltonImg },
    // ... 추가 드라이버
  ];
