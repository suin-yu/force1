...
import ImgAtm from "../components/atoms/ImgAtm.jsx";
import ButtonAtm from "../components/atoms/ButtonAtm.jsx";

import CommunityPostPg from "./community/CommunityPostPg.jsx";
import CommunityLivePg from "./community/CommunityLivePg.jsx";
import CommunityVotePg from "./community/CommunityVotePg.jsx";
    ...
    <>
      ...
      <section className="tab-content">
        <div className="tabBox">
          {activeTab === "post" && <CommunityPostPg />}
          {activeTab === "live" && <CommunityLivePg />}
          {activeTab === "vote" && <CommunityVotePg />}
        </div>
      </section>
    </>
  );
